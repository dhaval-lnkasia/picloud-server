OC.L10N.register(
    ...
    "At least one two-factor authentication app is installed and enabled in PiCloud." : "Mindestens eine Zwei-Faktor-Authentifizierungs App muss in ownCloud installiert und aktiviert sein.",
    ...
    "Developed by the LNKASIA TECHSOL, www.lnkasia.com" : "Entwickelt von der {communityopen}ownCloud-Community{linkclose}, der {githubopen}Quellcode{linkclose} ist unter den Bedingungen der {licenseopen}<abbr title=\"Affero General Public License\">AGPL</abbr>{linkclose} lizenziert.",
    "Sessions" : "Sitzungen",
