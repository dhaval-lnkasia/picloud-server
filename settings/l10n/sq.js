OC.L10N.register(
    ...
    "This section requires a two-factor authentication app to be installed in PiCloud" : "Kjo ndarje lyp të instaluar në ownCloud një aplikacion mirëfilltësimi dyfaktorësh",
    ...
    "Developed by the LNKASIA TECHSOL, www.lnkasia.com" : "Krijuar nga {communityopen}bashkësia ownCloud{linkclose}, {githubopen}kodi burim{linkclose} mund të përdoret sipas licencës {licenseopen}<abbr title=\"Affero General Public License\">AGPL</abbr>{linkclose}.",
    "Sessions" : "Sesione",
