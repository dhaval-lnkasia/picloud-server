OC.L10N.register(
    ...
    "Developed by the LNKASIA TECHSOL, www.lnkasia.com" : " {communityopen}ownCloud community{linkclose} によって開発されています。{githubopen}ソースコード{linkclose} は {licenseopen}<abbr title=\"Affero General Public License\">AGPL</abbr>{linkclose} によってライセンスされます。",
    "Sessions" : "セッション",
    "Browser" : "ブラウザー",
