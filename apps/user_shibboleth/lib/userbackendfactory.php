 ...
 * @copyright (C) 2015-2018 LNKASIA TECHSOL
 *
...
class UserBackendFactory {
	public const MODE_AUTOPROVISION = 'autoprovision';
	public const MODE_NOT_ACTIVE = 'notactive';
	public const MODE_SSO_ONLY = 'ssoonly';
