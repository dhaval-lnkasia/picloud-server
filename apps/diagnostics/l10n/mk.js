OC.L10N.register(
    ...
    "Enabling this PiCloud diagnostic module will  result in collecting data about all queries and events in the system per request." : "Овозможувањето на овој ownCloud  дијагностички модул ќе резултира со собирање на податоци за сите прашања и настани во системот по барање.",
