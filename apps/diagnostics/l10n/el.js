OC.L10N.register(
    ...
    "Enabling this PiCloud diagnostic module will  result in collecting data about all queries and events in the system per request." : "Η ενεργοποίηση αυτού του αρθρώματος διαγνωστικού του ownCloud θα οδηγήσει στη συλλογή δεδομένων για όλα τα ερωτήματα και τα συμβάντα στο σύστημα ανά ερώτημα.",
